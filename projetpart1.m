...
y1e(1,:)=yc1(1,:);
for i=1:n-1
    y1e(i+1,:)=y1e(i,:)+dt*fcte(t(i),y1e(i,:));
end
...
for i=1:n-1
    k=fcte(t(i),y12(i,:));
    y12(i+1,:)=y12(i,:)+dt*fcte(t(i)+dt/2,y12(i,:)+dt/2*k);
end
...
for i=1:n-1
    k1=fcte(t(i),y14(i,:));
    k2=fcte(t(i)+dt/2,y14(i,:)+dt/2*k1);
    k3=fcte(t(i)+dt/2,y14(i,:)+dt/2*k2);
    k4=fcte(t(i)+dt,y14(i,:)+dt*k3);
...
y2e(1,:)=yc2(1,:);
for i=1:n-1
    y2e(i+1,:)=y2e(i,:)+dt*fcte(t(i),y2e(i,:));
end
%methode ordre 2 (rk2)
y22(1,:)=yc2(1,:);
for i=1:n-1
    k=fcte(t(i),y22(i,:));
    y22(i+1,:)=y22(i,:)+dt*fcte(t(i)+dt/2,y22(i,:)+dt/2*k);
end
% ordre 4
y24=zeros(n,2);
y24(1,:)=yc2(1,:);
for i=1:n-1
    k1=fcte(t(i),y24(i,:));
    k2=fcte(t(i)+dt/2,y24(i,:)+dt/2*k1);
    k3=fcte(t(i)+dt/2,y24(i,:)+dt/2*k2);
    k4=fcte(t(i)+dt,y24(i,:)+dt*k3);
